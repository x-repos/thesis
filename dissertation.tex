...
\input{chapter/02-background}
\input{chapter/03-seismic-traveltime-annealing}
\input{chapter/04-paper-two}
\input{chapter/05-conclusions}
...
% \input{chapter/A-Appendix}   % add your appendices here; examples are in template/chapter/
